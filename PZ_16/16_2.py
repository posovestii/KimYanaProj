...
print("Моя собака вида: " + my_dog.species + ", возрастом:", my_dog.age, "лет, " + "породы: " + my_dog.breed + ".")
print("Моя кошка вида: " + my_cat.species + ", возрастом:", my_cat.age, "лет, " + "породы: " + my_cat.breed + ".")
